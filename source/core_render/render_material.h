...
namespace nene::r
{
	...
	{
	public:
		render_material(std::unordered_map<uint32_t, std::shared_ptr<render_texture>> render_textures);
	...
	protected:
		...
		std::unordered_map<uint32_t, std::shared_ptr<render_texture>> m_texture_bindings;
