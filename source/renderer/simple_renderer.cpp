...
#include "core_render/system_buffers.h"
	...
	, m_screen_pass_pipeline_state(nullptr)
{
	...
	const auto desc = gapi_texture_desc::create_2d({1920, 1080}, gapi_pixel_format::r8g8b8a8, gapi_texture_create_flag::as_shader_resource | gapi_texture_create_flag::as_render_target);
