...
namespace nene
{
	...
	class gapi_d3d12_offline_resource_view_page_allocator : public gapi_resource_view_allocator
	{
	public:
		...
		void reset() override {}
		std::shared_ptr<gapi_resource_view> allocate_resource_view(gapi_resource_view_type vtype) override;
	...
	protected:
		...
		//
		void free_resource_view(gapi_resource_view* view);
	...
	class gapi_d3d12_online_resource_view_frame_allocator : public gapi_resource_view_allocator
	{
	public:
