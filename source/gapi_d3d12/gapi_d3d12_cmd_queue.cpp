...
uint64 gapi_d3d12_cmd_queue::signal()
{
...
void gapi_d3d12_cmd_queue::wait_for_fence_value(uint64 fence_value)
{
...
void gapi_d3d12_cmd_queue::execute_cmd_list(const std::shared_ptr<i::gapi_cmd_list>& cmd_list)
{
