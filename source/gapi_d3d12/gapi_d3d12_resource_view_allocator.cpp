...
namespace nene
{
	...
	std::shared_ptr<gapi_resource_view> gapi_d3d12_offline_resource_view_page_allocator::allocate_resource_view(gapi_resource_view_type vtype)
	{
		//
	...
	void gapi_d3d12_offline_resource_view_page_allocator::free_resource_view(gapi_resource_view* view)
	{
	...
	std::shared_ptr<gapi_resource_view> gapi_d3d12_online_resource_view_frame_allocator::allocate_resource_view(gapi_resource_view_type vtype)
	{
