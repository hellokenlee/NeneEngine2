...
namespace nene
{
	...
	void gapi_d3d12_cmd_list::reset(const std::shared_ptr<gapi_cmd_allocator>& allocator, const std::shared_ptr<gapi_pipeline_state>& pipeline_state)
	{
		//
	...
	void gapi_d3d12_cmd_list::clear_state(const std::shared_ptr<gapi_pipeline_state>& pipeline_state)
	{
		m_d3d_list->ClearState(t::gapi_pin<gapi_d3d12_pipeline_state>(pipeline_state).get_d3d_pipeline_state());
	}

	void gapi_d3d12_cmd_list::clear_depth_stencil_view(const std::shared_ptr<gapi_resource_view>& depth_stencil, const float& depth, const uint8_t& stencil)
	{
	...
	void gapi_d3d12_cmd_list::clear_render_target_view(const std::shared_ptr<gapi_resource_view>& render_target, const color::rgba<float>& clear_color)
	{
	...
	void gapi_d3d12_cmd_list::clear_unordered_access_view(const std::shared_ptr<gapi_resource_view>& unorder_access_view, const std::shared_ptr<gapi_resource>& resource, const color::rgba<float>& clear_color)
	{
	...
	void gapi_d3d12_cmd_list::copy_resource(const std::shared_ptr<gapi_resource>& dst, const std::shared_ptr<gapi_resource>& src)
	{
	...
	void gapi_d3d12_cmd_list::copy_buffer_region(const std::shared_ptr<gapi_buffer>& dst, uint32_t dst_offset, const std::shared_ptr<gapi_buffer>& src, uint32_t src_offset, uint64_t num_bytes)
	{
		// buffer -> buffer copy
	...
	void gapi_d3d12_cmd_list::copy_texture_region(const std::shared_ptr<gapi_texture>& dst, uint32_t dst_subindex, const std::shared_ptr<gapi_texture>& src, uint32_t src_subindex)
	{
	...
	void gapi_d3d12_cmd_list::copy_buffer_region(const std::shared_ptr<gapi_texture>& dst, uint32_t dst_subindex, const std::shared_ptr<gapi_buffer>& src, const std::shared_ptr<gapi_buffer_sublayout>& src_sublayout)
	{
		// buffer -> texture copy
		auto& d3d_dst = t::gapi_pin<gapi_d3d12_texture>(dst);
	...
	void gapi_d3d12_cmd_list::discard_resource(const std::shared_ptr<gapi_resource>& resource)
	{
	...
	void gapi_d3d12_cmd_list::execute_indirect(const std::shared_ptr<gapi_cmd_layout>& layout, uint32_t max_num_cmd, const std::shared_ptr<gapi_buffer>& arg_buffer, uint32_t arg_buffer_offset, const std::shared_ptr<gapi_buffer>& count_buffer,
		uint32_t count_buffer_offset)
	{
		NOT_IMPLEMENTED();
	}

	void gapi_d3d12_cmd_list::set_pipeline_state(const std::shared_ptr<gapi_pipeline_state>& pipeline_state)
	{
	...
	void gapi_d3d12_cmd_list::bind_root_constant_buffer(uint32_t parameter_index, const std::shared_ptr<gapi_buffer>& buffer)
	{
	...
	void gapi_d3d12_cmd_list::bind_root_shader_resource(uint32_t parameter_index, const std::shared_ptr<gapi_resource>& resource)
	{
	...
	void gapi_d3d12_cmd_list::bind_root_unordered_access(uint32_t parameter_index, const std::shared_ptr<gapi_resource>& resource)
	{
		const auto& d3d_resource = t::gapi_pin<gapi_d3d12_resource>(resource);
	...
	void gapi_d3d12_cmd_list::set_index_buffer(const std::shared_ptr<gapi_buffer>& index_buffer)
	{
	...
	void gapi_d3d12_cmd_list::set_render_targets(const std::vector<std::shared_ptr<gapi_resource_view>>& render_target_views, const std::shared_ptr<gapi_resource_view>& depth_stencil_view)
	{
