...
void gapi_d3d12_cmd_list::set_descriptor_heaps(const std::vector<std::shared_ptr<i::gapi_descriptor_heap>>& heaps)
{
}

void gapi_d3d12_cmd_list::set_index_buffer(const std::shared_ptr<i::gapi_index_buffer_view>& index_buffer)
{
	CHECK(false);
	// m_list->IASetIndexBuffer()
}

void gapi_d3d12_cmd_list::set_vertex_buffer(const std::shared_ptr<i::gapi_vertex_buffer_view>& vertex_buffer)
{
	CHECK(false);
...
void gapi_d3d12_cmd_list::transition_resource(const std::shared_ptr<i::gapi_resource>& resource, const gapi_resource_state& transition)
{
	CHECK(false);
