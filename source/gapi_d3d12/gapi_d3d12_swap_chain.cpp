...
namespace nene
{
	...
	const std::shared_ptr<gapi_texture>& gapi_d3d12_swap_chain::get_back_buffer() const
	{
	...
	{
		// clear first, `ResizeBuffers(...)` will invalidate the `ID3D12Resource` in swapc hain
