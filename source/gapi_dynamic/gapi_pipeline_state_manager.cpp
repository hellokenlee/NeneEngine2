...
const std::shared_ptr<i::gapi_pipeline_state>& gapi_pipeline_state_manager::find_or_create_pipeline_state(const gapi_compute_pipeline_state_desc& desc)
{
...
const std::shared_ptr<i::gapi_pipeline_state>& gapi_pipeline_state_manager::find_or_create_pipeline_state(const gapi_graphics_pipeline_state_desc& desc)
{
	// TODO: Hashing and Caching
