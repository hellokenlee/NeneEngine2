...
gapi_cmd_context::gapi_cmd_context(const t::shared_ptr<i::gapi_device>& device)
	: m_current(0)
...
void gapi_cmd_context::transition_resource(const t::shared_ptr<i::gapi_resource>& resource, const gapi_resource_state& from, const gapi_resource_state& to) const
{
...
void gapi_cmd_context::set_pipeline_state(t::shared_ptr<i::gapi_pipeline_state>& pipeline_state) const
{
	// TODO: Pipeline state cache
	get_current_cmd_list()->set_pipeline_state(pipeline_state);
}

void gapi_cmd_context::set_index_buffer(const t::shared_ptr<i::gapi_index_buffer_view>& index_buffer) const
{
	// TODO: Input assembly cache
	get_current_cmd_list()->set_index_buffer(index_buffer);
}

void gapi_cmd_context::set_vertex_buffer(const t::shared_ptr<i::gapi_vertex_buffer_view>& vertex_buffer) const
{
	// TODO: Input assembly cache
...
void gapi_cmd_context::set_viewports(const t::dynamic_array<gapi_viewport_desc>& viewports) const
{
	// TODO: Rasterizer state cache
	get_current_cmd_list()->set_viewports(viewports);
}

void gapi_cmd_context::set_scissor_rects(const t::dynamic_array<rect>& scissors) const
{
	// TODO: Rasterizer state cache
	get_current_cmd_list()->set_scissor_rects(scissors);
}

void gapi_cmd_context::bind_shader_resource(const gapi_shader_type& stage, const t::shared_ptr<i::gapi_resource>& resource) const
{
