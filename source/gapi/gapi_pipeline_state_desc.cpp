...
namespace nene
{
	...
	gapi_bound_shader_state_desc::gapi_bound_shader_state_desc(const gapi_vertices_declaration& vertex_declaration, const std::shared_ptr<gapi_shader>& vertex_shader)
	...
	gapi_bound_shader_state_desc::gapi_bound_shader_state_desc(const gapi_vertices_declaration& vertex_declaration, const std::shared_ptr<gapi_shader>& vertex_shader, const std::shared_ptr<gapi_shader>& pixel_shader)
		: m_vertices_declaration(vertex_declaration)
	{
		m_stage_shaders[magic_enum::enum_underlying(gapi_shader_stage::vertex_shader)] = vertex_shader;
	...
	gapi_bound_shader_state_desc::gapi_bound_shader_state_desc(const std::shared_ptr<gapi_shader>& compute_shader)
	{
